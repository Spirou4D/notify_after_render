...
updater.addon = "notify_after_render"
...
class addon_updater_update_now(bpy.types.Operator):
	...
	bl_description = "Update to the latest version of the {x} addon".format(x=updater.addon)
	bl_options = {'REGISTER', 'INTERNAL'}
...
class addon_updater_update_target(bpy.types.Operator):
	...
	bl_description = "Install a targeted version of the {x} addon".format(x=updater.addon)
	bl_options = {'REGISTER', 'INTERNAL'}
...
def register(bl_info):
	...
	updater.user = "Spirou4D"

	# choose your own repository, must match git name
	updater.repo = "Notify-after-render"

	#updater.addon = # define at top of module, MUST be done first

	# Website for manual addon download, optional but recommended to set
	updater.website = "https://github.com/Spirou4D/Notify-after-render/"
	...
	updater.overwrite_patterns = ["*.png","*.jpg","README.md","LICENSE.txt", "LICENCE.md"]
