...
def get_save_ID():
    ...
    format = rndr.image_settings.file_format = bpy.context.scene.auto_save_format
...
class RENDER_OT_Sendmail(Operator):
    """Send Mail"""
    # bpy.ops.render.notify_sendmail()
...
class NAR_Addon_Preferences(AddonPreferences):
    bl_idname = __name__
